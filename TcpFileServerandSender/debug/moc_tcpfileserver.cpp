...
static constexpr auto qt_meta_stringdata_CLASSTcpFileServerENDCLASS = QtMocHelpers::stringData(
    "TcpFileServer",
    "serverStarted",
    "",
    "start",
...
Q_CONSTINIT static const qt_meta_stringdata_CLASSTcpFileServerENDCLASS_t qt_meta_stringdata_CLASSTcpFileServerENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(14, 13),  // "serverStarted"
        QT_MOC_LITERAL(28, 0),  // ""
        QT_MOC_LITERAL(29, 5),  // "start"
        QT_MOC_LITERAL(35, 16),  // "acceptConnection"
        QT_MOC_LITERAL(52, 14),  // "readClientData"
        QT_MOC_LITERAL(67, 12),  // "displayError"
        QT_MOC_LITERAL(80, 28),  // "QAbstractSocket::SocketError"
        QT_MOC_LITERAL(109, 11)   // "socketError"
    },
    "TcpFileServer",
    "serverStarted",
    "",
...
void TcpFileServer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (TcpFileServer::*)();
            if (_t _q_method = &TcpFileServer::serverStarted; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void TcpFileServer::serverStarted()
{
